...
const Portfolio = () => {
	...
	return (
		<section
			id="Portfolio"
			className="bg-sky-950 max-w-2xl">
			<h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-2xl dark:text-zinc-100 px-10">
			...
			<div className="px-10 group group-hover:scale-100 group-hover:opacity-100 my-10 flex flex-col justy-start  rounded">
